        ...
        <div className={styles.policyCard}>
          <header className={styles.cardHeader}>
            ...
            <div className={styles.addressInfo}>
              <strong> Z Foundation</strong><br />
              H:NO 1-65/S/469,KAKATIYA HILLS,<br/>
               GUTTALA_BEGUMPET,KAVURI HILLS,<br />
          ...
          <section className={styles.section}>
            ...
            <p>At Z Foundation ("we", "us", or "our"), we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you interact with us through our website, events, services, and communications.</p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p>To exercise your rights, contact us at: info[at]Zfoundation.org</p>
          </section>
          ...
          <footer className={styles.section}>
            ...
            <div className={styles.finalContact}>
              <p>📧 info[at]Zfoundation[dot]org</p>
