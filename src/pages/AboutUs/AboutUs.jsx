...
import HappyDonors from '../../components/HappyDonors/HappyDonors';
...
const AboutUs = () => {
  const valuesData = [
    ...
    },
    {
      ...
      text: 'ZFoundation celebrates diversity and ensures inclusion by empowering all—regardless of gender, age, or background—creating equal opportunities and a united, compassionate community.'
    },
    {
      title: 'Collaboration',
      icon: 'https://randomuser.me/api/portraits/women/44.jpg',
      text: 'Z Foundation thrives on collaboration, uniting communities, partners, and volunteers to drive impactful change through shared goals, collective action, and compassionate service for all.'
    },
    {
      title: 'Accountability',
      icon: 'https://randomuser.me/api/portraits/women/44.jpg',
      text: 'Z Foundation upholds accountability by staying transparent, responsible, and committed to our mission—ensuring every action, resource, and outcome serves the community with integrity and trust.'
    }
  ];
    ...
    <div className={styles.mainWrapper}>
      ...
      <div className={styles.welcomeContainer}>
        <div className={styles.innerContent}>
          <h2 className={styles.redHeading}>Welcome to Z Foundation</h2>
          <p className={styles.infoText}>
            Z Foundation is a non-profit organization established with a heartfelt mission to uplift the underserved and create lasting, meaningful change in society. Rooted in the values of compassion, inclusivity, and service, we work tirelessly to address the pressing social challenges faced by vulnerable communities across India.
          </p>
          <p className={styles.infoText}>
            At Z Foundation, we believe that real change starts at the grassroots. Our initiatives span across multiple impact areas, women empowerment, youth development, environmental responsibility, and social recognition.
          </p>
        </div>
      </div>
        ...
        <div className={styles.container}>
          <div className={styles.topVisionGrid}>
            ...
            <div className={styles.visionItem}>
              ...
              <p className={styles.visionPara}>Z Foundation is involved in a range of activities, including Women Empowerment, Child Education, Home for Senior citizens, Child Nurture, Humanitarian Relief etc. We believe in taking a holistic approach to address complex issues.</p>
            </div>
          </div>
          <div className={styles.helpFullWidth}>
            <h3 className={styles.redSubHeading}>How You Can Help</h3>
            <p className={styles.visionPara}>As a volunteer, there are several ways in which you can actively contribute to Z Foundation. By offering your time, skills, and resources, you can make a positive impact for those in need. Whether it's assisting an event, participating in fundraising events, or simply lending a helping hand to those less fortunate, your involvement can truly make a difference. Remember, every small act of kindness can go a long way in building a stronger and more supportive community.</p>
          </div>
        </div>
      </div>
